...
struct ContentView: View {
    ...
    init() {
            ...
            _startTime = State(initialValue: startTimeInterval != 0.0 ? Date(timeIntervalSinceReferenceDate: startTimeInterval) : defaultStartTime)
            _endTime = State(initialValue: endTimeInterval != 0.0 ? Date(timeIntervalSinceReferenceDate: endTimeInterval) : defaultEndTime)
        }
